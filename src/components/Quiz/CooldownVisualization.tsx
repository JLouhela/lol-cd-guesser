...
export function CooldownVisualization({ spell }: CooldownVisualizationProps) {
  ...
  const cooldownChanges = rank1Cooldown !== maxRankCooldown;
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
      ...
      {cooldownChanges ? (
        ...
        /* Single timer when cooldown doesn't change */
        <div className="flex justify-center">
          <div className="text-center">
            <h4 className="text-lg font-semibold text-yellow-400 mb-4">Rank 1 to {maxRank}</h4>
            <div className="relative w-48 h-48 mx-auto">
              <svg className="transform -rotate-90" width="192" height="192">
                <circle
                  cx="96"
